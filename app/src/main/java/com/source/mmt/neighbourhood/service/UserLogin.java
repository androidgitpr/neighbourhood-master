...
public class UserLogin extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"/getUser");

            Userinfo inParam = new Userinfo();
            inParam.setMobileNum(params[0]);
            inParam.setPwd(params[1]);
            ...
            if((line = reader.readLine())!=null){
                System.out.println("shiva get user login response "+line);
            }
