...
public class GetApartment extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost(url_base+"/apartment");

            Apartment input = new Apartment();
            input.setAction("get");
    ...
    private void parseResult(String result) {
        ...
        try {
            ...
            nhInst.setApartmentsList(objectMapper.readValue(result, new TypeReference<List<Apartment>>() {
            }));
        }catch (Exception e) {
